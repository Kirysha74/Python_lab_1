...
def get_past_day(date):
    return date - datetime.timedelta(1)

def record_currency_rate(file_name = "dataset1", boundary_date = datetime.date(2023, 1, 1), valute = "USD"):
    ...
    while date >= boundary_date:
        ...
        url = "https://www.cbr-xml-daily.ru/archive/" + get_date(date) + "/daily_json.js"
